...
extern void Test_iniparser_getlongint(CuTest*);
...
extern void Test_iniparser_error_callback(CuTest*);
...
void RunAllTests(void) 
{
    ...
    SUITE_ADD_TEST(suite, Test_iniparser_getlongint);
    ...
    SUITE_ADD_TEST(suite, Test_iniparser_error_callback);
